...
class Profile(models.Model):
    ...
    jobs = models.ManyToManyField('Job', null=True, blank=True, default=None,
                                  related_name='jobs_set')  # profile_job 테이블 자동 생성
    ...
    def already_clicked(self,
                        to_prof):  # self가 to_prof(id값?)를 이미 추천 줬으면 True . 안줬으면 False (view에서 pro.already_clicked == True면 raise이미했어. False면 recomm에추가(add)
